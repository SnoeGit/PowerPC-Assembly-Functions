...
int SHIELD_DRAIN_SPEED_INDEX = -1;
...
void CodeMenu()
{
	...
	ConstantsLines.push_back(new Floating("Hitstun Multiplier", 0, 99, 0.4, .01, HITSTUN_MULTIPLIER_INDEX, "%.3f"));
	...
	ConstantsLines.push_back(new Floating("Electric Hitlag Multiplier", 0, 99, 1.5, .1, ELECTRIC_HITLAG_MULTIPLIER_INDEX, "%.3f"));
	...
	ConstantsLines.push_back(new Floating("Shield Drain Rate", -99, 99, 0.28, .01, SHIELD_DRAIN_SPEED_INDEX, "%.3f"));
	constantOverrides.emplace_back(0x80B88450, SHIELD_DRAIN_SPEED_INDEX);
	...
	ConstantsLines.push_back(new Floating("Shield Strength", 0, 999, 60, 1, SHIELD_STRENGTH_INDEX, "%.3f"));
	...
	ConstantsLines.push_back(new Floating("Shield Tilt Multiplier", -99, 99, 0.5, .05, SHIELD_TILT_MULTIPLIER_INDEX, "%.3f"));
	...
	ConstantsLines.push_back(new Floating("Wall Bounce Knockback Multiplier", -99, 99, 0.80, .02, WALL_BOUNCE_KNOCKBACK_MULTIPLIER_INDEX, "%.3f"));
	constantOverrides.emplace_back(0x80B88510, WALL_BOUNCE_KNOCKBACK_MULTIPLIER_INDEX);
	ConstantsLines.push_back(new Floating("Knockback Decay Rate", -99, 99, 0.051, .001, KNOCKBACK_DECAY_MULTIPLIER_INDEX, "%.3f"));
